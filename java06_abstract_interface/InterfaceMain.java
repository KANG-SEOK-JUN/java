...
//implements키워드를 이용하여 상속을 받은 후 모든 추상 메소드를 오버라이딩하여야 한다.
//interface는 여러개 상속 받을 수 있다.
public class InterfaceMain  extends AbstractTest implements InterfaceA,InterfaceC{
	...
	public static void main(String[] args) {
		...
		//interface를 상속받는 클래스의 객체생성과 대입
		// new InterfaceA(); ->interface이므로 객체 생성 불가
		
		InterfaceA a = new InterfaceMain();
		System.out.println("hqp->"+a.hap(100, 25));
		
		//a.output();	//InterfaceC의 메소드 output은 숨겨져 있다.
